const NGOProfileUser = () => {
    return (
      <div className="relative bg-whitesmoke-100 w-full h-[1591px] overflow-hidden text-left text-5xl text-dimgray font-poppins">
        <img
        ...
        />
        <img
          className="absolute top-[186px] left-[117px] rounded-3xs w-[1285px] h-[1298px]"
          alt=""
        ...
        <div className="absolute top-[477px] left-[429px] w-[247px] h-[71px] text-gray-200">
          <div className="absolute top-[0px] left-[0px] rounded-11xl bg-gold-100 w-[247px] h-[71px]" />
          <div className="absolute top-[18px] left-[30.88px] font-medium flex items-center w-[216.13px] h-[33px]">
            Volunteer Now
          </div>
        </div>
        ...
        />
        <img
          className="absolute h-[2.51%] w-[2.63%] top-[60.03%] right-[87.04%] bottom-[37.46%] left-[10.33%] max-w-full overflow-hidden max-h-full"
          alt=""
          src="/Vector9.svg"
        />
...
<nav
       ...
       <Link to={"/ngohome"}> <img
            ...
            src="/ngoicon.svg"
          /></Link>  
        <Link to={"/ngohome"}> <div className="absolute top-[44px] text-seagreen-100 font-bold left-[892px] text-mini font-poppins  text-left flex items-center w-[55px]">
            Home
          </div></Link> 
